Feature: shopping cart items maintenance
  ...
  as a user
  I want to update the number or remove items in the shopping cart

  @current_test
  @javascript
  Scenario: Non-logged in User adds items to shopping cart, then removes and updates line items
